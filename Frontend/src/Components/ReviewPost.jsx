...
function ReviewPost({ review }) {
    ...
    return (
        <div
            ...
            className="relative rounded-3xl p-6 backdrop-blur-xl transition-all duration-500 group overflow-hidden"
            style={{
        ...
        >
            ...
            <div className="flex items-center gap-3 relative">
                ...
                <div>
                    ...
                    <h3 className="font-semibold text-sm" style={{ color: "#2D2438" }}>
                        {review.user.username}
                    </h3>

                    <p className="text-xs" style={{ color: "#8B7BB5" }}>
            ...
            <div
                ...
                className="flex gap-4 mt-5 cursor-pointer relative"
            >
                ...
                <div className="relative shrink-0">
                    <img
                        ...
                        alt={review.title}
                        className="w-16 rounded-xl shadow-sm transition-transform duration-500 group-hover:scale-[1.05] group-hover:-rotate-1"
                    />
                    <div
                ...
                <div className="min-w-0">
                    ...
                    <h2
                        className="text-base font-serif italic font-semibold truncate"
                        style={{ color: "#2D2438" }}
                    >
                        {review.title}
                    </h2>

                    <p className="text-sm mt-0.5 truncate" style={{ color: "#8B7BB5" }}>
                        {review.authors.join(", ")}
                    </p>
